...
class TestParsing:
    ...
    invalid_steps_missing_operation_id_file_path = (
        "./tests/fixtures/invalid/steps/missing_property.yml"
    )
    invalid_spec_missing_openapi_property_file_path = (
        "./tests/fixtures/invalid/specs/invalid_spec_1.yml"
    )
    ...
    def test_parse_steps_file_with_missing_operation_id(self):
        ...
        with pytest.raises(ValidationError) as e:
            invalid_steps = parse_steps_file(
                self.invalid_steps_missing_operation_id_file_path
            )
